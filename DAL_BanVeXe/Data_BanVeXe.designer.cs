...
namespace DAL_BanVeXe
{
	...
	public partial class CHUYENDI : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ID_TAIXE;
    ...
    partial void OnID_TAIXEChanging(System.Nullable<int> value);
    partial void OnID_TAIXEChanged();
    ...
    partial void OnGIODIChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_TAIXE", DbType="Int")]
		public System.Nullable<int> ID_TAIXE
		{
			get
			{
				return this._ID_TAIXE;
			}
			set
			{
				if ((this._ID_TAIXE != value))
				{
					this.OnID_TAIXEChanging(value);
					this.SendPropertyChanging();
					this._ID_TAIXE = value;
					this.SendPropertyChanged("ID_TAIXE");
					this.OnID_TAIXEChanged();
				}
			}
		}
